...
from database import units_collection as profiles, xp_collection as xp_profiles
...
class Profile(commands.Cog):
    ...
    async def profile(self,ctx, member : typing.Optional[discord.Member] = None ):
        ...
        background.rectangle((200, 90), width=680, height=2, fill="#ffffff") # line break
        # background.text(
        #     (260, 130),
        #     f"Level :",
        #     font=poppins_small,
        ...
        check = False
        roles = ['Einzig', 'Elven High Council Plenipotentiary', 'Dwarven Master Craftsman']
        for name in roles:
